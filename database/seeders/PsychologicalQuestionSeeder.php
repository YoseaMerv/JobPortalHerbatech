...
class PsychologicalQuestionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $msdtQuestions = [
            ...
            // ... Tambahkan soal 5 - 64 sesuai buku soal MSDT Anda
        ];

        foreach ($msdtQuestions as $q) {
            PsychologicalQuestion::create([
                'test_type' => 'msdt',
        ...
        // Catatan: Papi memerlukan pemetaan dimensi (G, L, I, dll) untuk scoring otomatis nantinya.
        $papiQuestions = [
            ...
            // ... Tambahkan soal 11 - 90 sesuai standar PAPI Kostick
        ];
        ...
        foreach ($papiQuestions as $q) {
            PsychologicalQuestion::create([
                ...
                'option_a' => $q['a'],
                'option_b' => $q['b'],
                'dimension_a' => $q['da'] ?? null,
                'dimension_b' => $q['db'] ?? null,
            ]);
        }
    }
}
