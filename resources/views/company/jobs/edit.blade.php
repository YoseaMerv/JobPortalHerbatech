            ...
            <div class="card-body">
                <form action="{{ route('company.jobs.update', $job->id) }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="text-primary mb-0">Ubah Lowongan: {{ $job->title }}</h5>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            ...
                            <input type="number" class="form-control @error('vacancy') is-invalid @enderror" id="vacancy" name="vacancy" value="{{ old('vacancy', $job->vacancy) }}" min="1">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('experience_level') is-invalid @enderror" id="experience_level" name="experience_level" value="{{ old('experience_level', $job->experience_level) }}" required placeholder="Contoh: 1 Tahun, Entry Level">
                    ...
                    <div class="mb-3">
                         <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_remote" id="is_remote" value="1" {{ old('is_remote', $job->is_remote) ? 'checked' : '' }}>
