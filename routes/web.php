...
Route::prefix('seeker')->name('seeker.')->middleware(['auth', 'verified', 'role:seeker'])->group(function () {
    ...
    Route::prefix('kraepelin')->name('kraepelin.')->group(function () {
        ...
        Route::get('applications/{application}/kraepelin-pdf', [KraepelinController::class, 'exportPdf'])->name('company.applications.kraepelin-pdf');
    });
    ...
    Route::post('/jobs/{job}/apply', [App\Http\Controllers\Seeker\JobController::class, 'submitApplication'])->name('jobs.apply.submit');
