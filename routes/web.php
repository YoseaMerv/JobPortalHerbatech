...
use App\Http\Controllers\Company\Kraepelin\KraepelinController as CompanyKraepelinController;
...
Route::prefix('seeker')->name('seeker.')->middleware(['auth', 'verified', 'role:seeker'])->group(function () {
    ...
    Route::middleware(['prevent.multiple.accepted'])->group(function () {
    ...
    // Tes Kraepelin
    Route::get('/kraepelin-test/{application}/instructions', [CompanyKraepelinController::class, 'showInstructions'])
        ->name('kraepelin.instructions');

    Route::get('/kraepelin-test/{application}/start', [CompanyKraepelinController::class, 'startTest'])
        ->name('kraepelin.start');

    Route::post('/kraepelin-test/{test}/submit', [CompanyKraepelinController::class, 'submitTest'])
        ->name('kraepelin.submit');
